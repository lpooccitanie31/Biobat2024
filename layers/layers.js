...
lyr_GoogleSatellite_0.setVisible(true);lyr_GoogleRoad_1.setVisible(true);lyr_Communes_2.setVisible(true);lyr_Mailles_3.setVisible(true);lyr_DPE_4.setVisible(true);lyr_Martinetsnoirs_5.setVisible(true);lyr_Hirondellesdefentre_6.setVisible(true);lyr_Hirondellesdefentre2022_7.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_GoogleRoad_1,lyr_Communes_2,lyr_Mailles_3,lyr_DPE_4,lyr_Martinetsnoirs_5,lyr_Hirondellesdefentre_6,lyr_Hirondellesdefentre2022_7];
