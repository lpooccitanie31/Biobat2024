...
jsonSource_Martinetsnoirs_4.addFeatures(features_Martinetsnoirs_4);cluster_Martinetsnoirs_4 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_Martinetsnoirs_4
});
var lyr_Martinetsnoirs_4 = new ol.layer.Vector({
                declutter: true,
                source:cluster_Martinetsnoirs_4, 
...
lyr_Ortho20cm_0.setVisible(true);lyr_PlanIGNj1_1.setVisible(true);lyr_Communes_2.setVisible(true);lyr_Mailles_3.setVisible(true);lyr_Martinetsnoirs_4.setVisible(true);lyr_Hirondellesdefentre_5.setVisible(true);lyr_Hirondellesdefentre2022_6.setVisible(true);
var layersList = [lyr_Ortho20cm_0,lyr_PlanIGNj1_1,lyr_Communes_2,lyr_Mailles_3,lyr_Martinetsnoirs_4,lyr_Hirondellesdefentre_5,lyr_Hirondellesdefentre2022_6];
...
lyr_Hirondellesdefentre2022_6.set('fieldLabels', {'Nom espece': 'hidden field', 'Date': 'hidden field', 'Commune': 'hidden field', 'Nom rue et n°': 'hidden field', 'Nbre de nids': 'hidden field', 'Nbr total nids occupÃ©s': 'hidden field', 'Nbre de nids dÃ©truits': 'hidden field', 'latitude': 'hidden field', 'longitude': 'hidden field', 'erreur': 'hidden field', });
